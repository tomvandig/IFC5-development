...
function CollectInheritsAsChildren(input, children) {
  input.forEach((input2) => {
    if (input2.inherits) {
      input2.inherits.forEach((parent) => {
        MMSet(children, input2.name, CleanInherit(parent));
      });
    }
  });
}
...
function BuildTreeNodeFromIntermediateComposition(node, parentPath, ic) {
...
// ../../schema/out/@typespec/json-schema/Ifc5SchemaMap.json
var Ifc5SchemaMap_default = [
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "Class.json",
    type: "object",
  ...
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "ifc5spaceboundaryComponent.json",
    type: "object",
    properties: {
      "ifc5:spaceboundary": {
        type: "object",
  ...
  },
  {
    ...
    properties: {
      ...
      attributes: {
        anyOf: [
          {
            $ref: "ifc5alignmentsegmentComponent.json"
          },
          {
            $ref: "ifc5alignmentComponent.json"
          },
          {
            $ref: "UsdShadeMaterialComponent.json"
          },
          {
            $ref: "ifc5spaceboundaryComponent.json"
          },
          {
            $ref: "NLSFBComponent.json"
          },
          {
            $ref: "UsdGeomBasisCurvesComponent.json"
          },
          {
            $ref: "PropertiesComponent.json"
          },
          {
            $ref: "CustomDataComponent.json"
          },
          {
            $ref: "xformOpComponent.json"
          },
          {
            $ref: "UsdShadeMaterialBindingAPIComponent.json"
          },
          {
            $ref: "UsdGeomMeshComponent.json"
          },
          {
            $ref: "UsdGeomVisibilityAPIvisibilityComponent.json"
          },
          {
            $ref: "Ifc5ClassComponent.json"
          }
        ]
      }
    },
  ...
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "UsdGeomBasisCurvesComponent.json",
    type: "object",
    properties: {
      "UsdGeom:BasisCurves": {
        type: "object",
  ...
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "UsdGeomVisibilityAPIvisibilityComponent.json",
    type: "object",
    properties: {
  ...
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "UsdShadeMaterialBindingAPIComponent.json",
    type: "object",
    properties: {
  ...
  {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "UsdShadeMaterialComponent.json",
    type: "object",
    properties: {
      "UsdShade:Material": {
        type: "object",
...
function addModel(name, modelData) {
  const ajv = new import__.default({ schemas: Ifc5SchemaMap_default });
...
` + JSON.stringify(validate.errors, null, 4);
  ...
  const validatedModelData = modelData;
